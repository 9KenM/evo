...
STAR.generate = function(massInitial, age){
	...
	//ZAMS properties
	star.massInitial = massInitial; // Solar mass
	star.lumInitial = STAR.lumInitial(star); // Solar lum
	star.radInitial = STAR.radInitial(star); // Solar radii
	star.tempInitial = STAR.tempInitial(star); // K

	//Lifetimes
	star.lifeMS = STAR.lifeMS(star); // Billions of years
	star.lifeSG = STAR.lifeSG(star); // Billions of years
	star.lifeRG = STAR.lifeRG(star); // Billions of years

	//Current properties
	star.age = age; // Billions of years
	star.stage = STAR.stage(star);
	star.lum = STAR.lum(star);
	star.temp = STAR.temp(star);
	star.rad = STAR.rad(star);
	star.mass = STAR.mass(star);
